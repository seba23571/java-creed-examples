...
@ThreadSafe
public class AsynchLoggerFactory implements ILoggerFactory {
  ...
  public Logger getLogger(final String name) {
    ...
    final AsynchLogger asynchLogger = new AsynchLogger(new RemoteLogger(name));
    if (loggerMap.putIfAbsent(loggerName, asynchLogger) == null) {
      asynchLogger.init();
      asynchLogger.registerShutdownHook();
    }
