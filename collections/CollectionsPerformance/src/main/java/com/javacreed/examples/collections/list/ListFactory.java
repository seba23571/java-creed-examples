...
public interface ListFactory {
	...
	ListFactory ARRAY_LIST_WITH_SIZE_FACTORY = new AbstractListFactory(
			"ArrayList with init size") {
		@Override
		public List<String> create(final int size) {
			return new ArrayList<>();
		}
	...
	ListFactory VECTOR_WITH_SIZE_FACTORY = new AbstractListFactory(
			"Vector with init size") {
		@Override
		public List<String> create(final int size) {
