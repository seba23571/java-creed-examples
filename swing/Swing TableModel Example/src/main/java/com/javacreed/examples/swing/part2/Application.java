...
public class Application extends JFrame {
    ...
    public Application() {
        ...
        final EmployeeTableModel employeeTableModel = new EmployeeTableModel();
        employeeTableModel.setEmployees(Employee.createSample());
        add(new JScrollPane(new JTable(employeeTableModel)));

        final ItemTableModel itemTableModel = new ItemTableModel();
        itemTableModel.setItems(Item.createSample());
