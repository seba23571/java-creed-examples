...
public class CsvWithCustomTypeAdapterTest {

  private static class PersonCsvTypeAdapter extends AbstractCsvTypeAdapter<Person> {
    @Override
    public Person read(final CsvReader in) throws CsvException, IOException, UnsupportedOperationException {
      final Person person = new Person();
      in.beginLine();
      person.setName(in.readValue());
      person.setSurname(in.readValue());
      person.setAge(Integer.parseInt(in.readValue()));
      in.endLine();
      return person;
    }
  }
  ...
  public void test() {
    ...
    builder.registerTypeAdapter(Person.class, new PersonCsvTypeAdapter());
